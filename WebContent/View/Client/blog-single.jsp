                ...
                <div class="aa-blog-content aa-blog-details">
                  <article class="aa-blog-content-single">                        
                    ...
                    <figure class="aa-blog-img">
                      <a href="#"><img src="${url}/images/news/${boardnew.image_link}" alt="fashion img"></a>
                    </figure>
                ...
                <aside class="aa-blog-sidebar">
                  ...
                  <div class="aa-sidebar-widget">
                   ...
                   <c:forEach items="${boardnewlist}" var="boardnew" end="2">
                        <li>
                          <a class="aa-cartbox-img" href="Newdetail?id=${boardnew.id}"><img src="${url}/images/news/${boardnew.image_link}" alt="img bài viết"></a>
                          <div class="aa-cartbox-info">
                            <h4><a href="Newdetail?id=${boardnew.id}"><b>${boardnew.title }</b></a></h4>
