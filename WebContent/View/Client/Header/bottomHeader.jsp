...
<!--                <a href="index.jsp">
              ...
              <div class="aa-shipping-box">
                  ...
                  <a class="aa-shipping-boxsmall">
                      ...
                      <span class="aa-shipping-box-text">
                          <div class="aa-shipping-title">Hỗ trợ: 039.9644.306</div>
              ...
              <div class="aa-cartbox">
                ...
                <div class="aa-cartbox-summary">
                  ...
                  <c:forEach items="${order.items}" var="item" >
                    <li>
                      <a class="aa-cartbox-img" href="Cart"><img src="${url}/images/products/img-test/${item.product.image_link}" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="Cart">${item.product.name}</a></h4>
                  ...
                  <a class="aa-cartbox-checkout aa-primary-btn" href="Cart">Chi tiết</a>
