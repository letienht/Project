                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="${url}/images/products/img-test/${detail_product.image_link}" class="simpleLens-lens-image"><img src="${url}/images/products/img-test/${detail_product.image_link}" class="simpleLens-big-image"></a></div>
                      </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-prod-view-bottom">
                      <a class="aa-add-to-cart-btn" href="Addcart?product-id=${detail_product.id}">Thêm vào giỏ hàng</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade " id="review">
                 <div class="aa-product-review-area">
                   ...
                   <!-- review form -->
                   <form action="Review?id=${detail_product.id}" method="post" class="aa-review-form">
            ...
            <div class="aa-product-related-item">
              ...
              <ul class="aa-product-catg aa-related-item-slider">
                ...
                <c:forEach items="${productById}" var="product">
	                <li>
	                  <figure>
	                    <a class="aa-product-img" href="ProductDetail?id=${product.id}"><img src="${url}/images/products/img-test/${product.image_link}" alt=""></a>
	                    <a class="aa-add-card-btn"href="Addcart?product-id=${product.id}"><span class="fa fa-shopping-cart"></span>Thêm vào giỏ hàng</a>
	                     <figcaption>
	                      <h4 class="aa-product-title"><a href="ProductDetail?id=${product.id}">${product.name}</a></h4>
