            ...
            <div class="aa-product-catg-body">
              ...
              <ul class="aa-product-catg">
                ...
                <c:forEach items="${productlist}" var="product">
	                ...
	                <li>
	                  <figure>
	                    <a class="aa-product-img" href="ProductDetail?id=${product.id}"><img src="${url}/images/products/img-test/${product.image_link}" alt="${product.name}"></a>
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <c:forEach items="${catelist}" var="cate">
              	<li><a href="Product?id=${cate.id}">${cate.name}</a></li>
              </c:forEach>                
              </ul>
            </div>
              ...
              <div class="aa-recently-views">
                <ul>
                 <c:forEach items="${productlist}" var="product" end="2">
                  <li>
                    <a href="ProducDetail?id=${product.id}" class="aa-cartbox-img"><img alt="img" src="${url}/images/products/img-test/${product.image_link}"></a>
                    <div class="aa-cartbox-info">
                      <h4><a href="ProducDetail?id=${product.id}">${product.name }</a></h4>
                      <c:choose>
						<c:when test="${product.discount == 0}">
