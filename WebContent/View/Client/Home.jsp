...
<c:url value = "Template/assets" var="url"/>
  ...
  <!-- Start slider -->
  <jsp:include page = "./Slider/slider.jsp" flush = "true" />
  <!-- / slider -->
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="raucu">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="ProductDetail?id=${product.id}"><img src="${url}/images/products/img-test/${product.image_link}" alt="polo shirt img"></a>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="aa-latest-blog-single">
                  <figure class="aa-blog-img">                    
                    <a href="Newdetail?id=${boardnew.id}"><img src="${url}/images/news/${boardnew.image_link}" alt="Tin tức ${boardnew.title}"></a>  
                      <figcaption class="aa-blog-img-caption">
                      <span href="#"><i class="fa fa-clock-o"></i>${boardnew.created}</span>
                    </figcaption>                          
                  </figure>
                  <div class="aa-blog-info">
                    <h3 class="aa-blog-title"><a href="Newdetail?id=${boardnew.id}">${boardnew.title}</a></h3>
                    <p class="desc-boardnews">${boardnew.content}</p> 
                    <a href="Newdetail?id=${boardnew.id}" class="aa-read-mor-btn">Xem thêm<span class="fa fa-long-arrow-right"></span></a>
                  </div>
                </div>
              </div>
              </c:forEach>
