               ...
               <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><a class="remove" href="Deletecart?id=${item.product.id}"><fa class="fa fa-close"></fa></a></td>
                        <td><a href="ProductDetail?id=${item.product.id}"><img src="${url}/images/products/img-test/${item.product.image_link}" alt="img${item.product.name }"></a></td>
                        <td><a class="aa-cart-title" href="ProductDetail?id=${item.product.id}">${item.product.name }</a></td>
